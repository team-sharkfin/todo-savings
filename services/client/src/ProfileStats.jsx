  ...
  <div className="container-fluid my-2 p-2">
    ...
    <div className="collapse" id={props.collapse}>
      <div className="card card-body">
        <p>
          {props.task}{" "}
          <span className="badge" id={props.badge}>
            {props.due}
          </span>
        </p>
      </div>
    ...
    <div className="collapse" id="settings">
      <div className="card card-body">
        <form>
          ...
          <div className="mb-3">
            <label htmlFor="bdayInput" className="form-label">
              Birthday
            </label>
            <input
              type="date"
              ...
              name="bdayInput"
            />
            <div id="bdayHelp" className="form-text">
              Add your birthday to personalize your profile.
            </div>
          </div>
