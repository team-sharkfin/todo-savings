  ...
  <div className="col-sm-6 p-3">
    ...
    <ul className="list-unstyled">
      <li>
        ...
        <p className="num-count">{props.allNum}</p>
      </li>
      <li>
        <strong>{props.year}</strong>
        <p className="num-count">{props.yearNum}</p>
      </li>
      <li>
        <strong>{props.month}</strong>
        <p className="num-count">{props.monthNum}</p>
      </li>
      <li>
        <strong>{props.week}:</strong>
        <p className="num-count">{props.weekNum}</p>
      </li>
    </ul>
  </div>
);
